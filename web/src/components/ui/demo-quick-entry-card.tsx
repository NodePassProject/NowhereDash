...
export function DemoQuickEntryCard() {
  ...
  const quickActions = [
    ...
    },
    {
      id: "add-subscription",
      icon: "lucide:rss",
      label: t("quickActions.addSubscription"),
      desc: t("quickActions.addSubscriptionDesc"),
      iconType: "iconify" as const,
      gradient:
        "bg-gradient-to-br from-rose-500 to-pink-600 dark:from-rose-500 dark:to-pink-700",
      ringHover:
        "group-hover:border-rose-300/60 dark:group-hover:border-rose-500/40",
  ...
  const handleActionClick = (actionId: string) => {
    switch (actionId) {
      ...
      case "add-subscription":
        navigate("/subscriptions?create=1");
        break;
    }
  };
