...
export default function DebugPage() {
  ...
  const [sseNowhereUrl, setSseNowhereUrl] = useState("");
  ...
  const runSSETest = useCallback(async () => {
    if (sseTesting || !sseNowhereUrl || !sseApiKey) return;
  ...
  }, [sseNowhereUrl, sseApiKey, sseTesting, t]);
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <div className="space-y-4">
                  <Input
                    ...
                    label={t("sseTest.modal.nowhereUrl")}
                    placeholder={t("sseTest.modal.nowhereUrlPlaceholder")}
                    startContent={
                      <FontAwesomeIcon
                    ...
                    value={sseNowhereUrl}
                    variant="bordered"
                    onValueChange={setSseNowhereUrl}
                  />
                  <Input
                    isDisabled={sseTesting}
              ...
              <ModalFooter>
                ...
                <Button
                  color="primary"
                  isDisabled={!sseNowhereUrl || !sseApiKey}
