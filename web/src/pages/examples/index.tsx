...
export default function ExamplesPage() {
  ...
  const docs: DocConfig[] = useMemo(() => {
    return [
      {
        key: "examples",
        url: "/docs-proxy/NodePassProject/Nowhere/refs/heads/main/docs/quick-start.md",
      },
      {
        key: "usage",
        url: "/docs-proxy/NodePassProject/Nowhere/refs/heads/main/docs/operations.md",
      },
      {
        key: "configuration",
        url: "/docs-proxy/NodePassProject/Nowhere/refs/heads/main/docs/configuration.md",
      },
      {
        key: "troubleshooting",
        url: "/docs-proxy/NodePassProject/Nowhere/refs/heads/main/docs/security.md",
      },
    ];
  }, []);
