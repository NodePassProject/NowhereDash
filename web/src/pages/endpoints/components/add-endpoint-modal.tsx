...
export default function AddEndpointModal({
  ...
  const [formData, setFormData] = useState<EndpointDraft>({
    name: "",
    url: "",
    apiKey: "",
    connectionIP: "",
  ...
  const handleInputChange = (field: keyof EndpointDraft, value: string) => {
    setFormData((prev) => {
      const updated = {
        ...prev,
        [field]: value,
                  ...
                  {step === "form" && (
                    ...
                    >
                      <div className="flex flex-col items-start">
                        <button
                          className="flex w-full cursor-pointer gap-4 rounded-md pb-6 text-left outline-none focus-visible:ring-2 focus-visible:ring-primary"
                          type="button"
