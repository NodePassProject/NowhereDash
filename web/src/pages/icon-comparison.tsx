...
const iconMappings = {
  ...
  heroicons: {
    隧道ID: "heroicons:identification",
    节点: "heroicons:server-stack",
  ...
  carbon: {
    隧道ID: "carbon:ibm-cloud-identity-access-management",
    节点: "carbon:cloud-service-management",
    版本号: "carbon:version",
